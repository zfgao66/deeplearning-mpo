...
#8x8
  ...
  inputs = batch_activ_conv(inputs,256,256, 3, strides=[1,1],cpu_variables=cpu_variables, train_phase=train_phase,prefix='conv3_3')
  inputs = batch_activ_conv(inputs,256,256, 3, strides=[1,1],cpu_variables=cpu_variables, train_phase=train_phase,prefix='conv3_4')
...
#4x4
  ...
  inputs = batch_activ_conv(inputs,512,512, 3, strides=[1,1],cpu_variables=cpu_variables, train_phase=train_phase,prefix='conv4_3')
  inputs = batch_activ_conv(inputs,512,512, 3, strides=[1,1],cpu_variables=cpu_variables, train_phase=train_phase,prefix='conv4_4')
...
#1x1
  ...
  inputs = tf.nn.relu(tensornet.layers.linear(inputs, 4096, cpu_variables=cpu_variables, scope='fc_1'))
  inputs = tf.nn.dropout(inputs,keep_prob=0.8)
  inputs = tf.nn.relu(tensornet.layers.linear(inputs, 4096, cpu_variables=cpu_variables, scope='fc_2'))
  inputs = tf.nn.dropout(inputs,keep_prob=0.8)
  inputs = tensornet.layers.linear(inputs, 10, cpu_variables=cpu_variables, scope='fc_3')
  return inputs
