...
#TTO_layer1
inp_modes1 =  [1,2,2,7,7,2,2,1]          
out_modes1 =  [2,2,2,2,2,2,2,2]       
mat_rank1  =  [1,r_1,r_1,r_1,r_1,r_1,r_1,r_1,1]

#TTO_layer2
inp_modes2 = [2,2,2,2,2,2,2,2]     
out_modes2 = [1,1,1,2,5,1,1,1]        
mat_rank2 =  [1,r_2,r_2,r_2,r_2,r_2,r_2,r_2,1]
