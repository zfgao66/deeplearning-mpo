...
flags.DEFINE_integer('tt_ranks',   3, 'ranks of tensor train')
...
if net_type == 'ResNet':
    ...
    flags.DEFINE_string('net_module', './nets/wideResNet-TT-ap.py', 'Module with architecture description.')
